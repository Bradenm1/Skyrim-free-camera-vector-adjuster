...
namespace Skyrim
{
    class FreeCamera
    {
        public static Int64 FREECAMERA = 0x01739A18; // Base pointer
        ...
        public static String RETURN_TYPE = "float";  // Type memory reads

        public static Int32 PLAYERCAMERA = 0x01B399A0;
